...
import { IonContent, IonPage, IonInput, IonSelect, IonSelectOption, IonButton, IonTextarea, IonIcon, IonAvatar, IonText } from '@ionic/react';
import UserService from '../../core/services/UserService';
import PatientService from '../../core/services/PatientService';
import { UserContext } from '../../context/userContext';

function PatientConfiguration() {
    ...
    useEffect(() => {
        ...
        const patientRole = roles.some(role => role.authority === "ROLE_PROFESSIONAL");
        setIsProfessional(patientRole);
    ...
    const handleUpdate = async () => {
        ...
        const completeData = {
            ...
            password: password || undefined, // Enviar nova senha se fornecida
            idProfilePicture: userData.idProfilePicture || undefined, // Preservar ID da foto de perfil, se existir
            address: {
        ...
        try {
            if (isProfessional) {
                ...
                await patientService.updatePatientByToken(completeData, token);
            }
            setUser(userData);
            setIsEditable(false);
                                ...
                                <div className='flex-col w-full mx-5 lg:w-3/4 mt-10 lg:mt-0'>
                                    <div className='flex w-2/5 lg:w-full items-center justify-between'>
                                        ...
                                        {isEditable ? (
                                            ...
                                            <IonButton onClick={() => setIsEditable(true)}>Editar</IonButton>
                                        )}
                                    </div>
                                    </div>
