...
const FinanceBalance = ({ transactions, loading }) => {
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center p-5" data-testid="moon-loader">
  ...
  return (
    <div className="p-5  lg:p-10 bg-white w-screen rounded-lg">
      <div className="flex justify-center  lg:justify-around gap-4">
        <div className="text-center w-1/3 " data-testid="entradas" >
        ...
        <div className="text-center w-1/3 lg:border-x-2 lg:border-gray-300" data-testid="saidas">
          <div className="flex items-center justify-center">
        ...
        <div className="text-center w-1/3" data-testid="balanço"> 
          <div className="flex items-center justify-center">
